...
# Identical to LengthProtocol but does not print debug when discarding FPrime's first 13 bytes sent
...
module Cosmos
  ...
  class RefProtocol < BurstProtocol
    ...
    def calculate_length(buffer_length)
        ...
        #print "\nCALCULATE_LENGTH: " + buffer_length.to_s + "\n"
    ...
    def reduce_to_single_packet
        ...
        #print "\nDATA: " + @data.to_s + "LENGTH: " + @data.length.to_s + "LENGTH BYTES NEEDED: " + @length_bytes_needed.to_s + "\n"
      ...
      length = BinaryAccessor.read(@length_bit_offset,
                                   ...
                                   @data,
                                   @length_endianness)
      # print "\nLENGTH: " + length.to_s + "LENGTH_BIT_OFFSET: " + @length_bit_offset.to_s + "DATA: " + @data.to_s + "LENGTH_ENDIANNESS: " + @length_endianness.to_s + "MAX_LENGTH: " + @max_length.to_s + "\n"
