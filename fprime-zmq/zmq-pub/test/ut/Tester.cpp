...
// \title  ZmqPub.hpp
// \author tcanham
// \brief  cpp file for ZmqPub test harness implementation class
//
// \copyright
...
namespace Zmq {
  ...
  Tester ::
    Tester(void) : 
      ...
      ZmqPubGTestBase("Tester", MAX_HISTORY_SIZE),
      component("ZmqPub")
#else
      ZmqPubGTestBase(MAX_HISTORY_SIZE),
      component()
#endif
  {
    this->initComponents();
