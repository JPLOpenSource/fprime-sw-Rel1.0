...
from views import command_panel
from views import log_event_panel
from views import telemetry_panel
from views import seq_panel
from views import status_panel
from views import status_bar
from views import file_panel
from views import stripchart_panel
from views import help_panel
