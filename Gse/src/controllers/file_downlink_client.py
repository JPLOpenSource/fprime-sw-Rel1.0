...
from models.serialize.filepacket import PacketType
from models.serialize import filepacket
...
class DownlinkShell(object):
	...
	def spawn(self, host, port):
		...
		downlink_path = self.__build_root +os.sep+ 'Gse' + os.sep + 'src' + os.sep + 'controllers' + os.sep + 'file_downlink_client.py'
