...
def main():
    ...
    for xml_filename in xml_filenames:       
        ...
        if xml_type == "component":
            ...
            DEPLOYMENT = opt.work_path + os.sep + DEPLOYMENT
            #
            # Open CSV files here...
            #
            cmd_fd = open(DEPLOYMENT + "_Commands.csv","w")
            cmd_writer = csv.writer(cmd_fd)
            PRINT.info("Opened: %s", DEPLOYMENT + "_Commands.csv")
            #
            cmd_fd_args = open(DEPLOYMENT + "_CommandsArgs.csv","w")
            cmd_writer_args = csv.writer(cmd_fd_args)
            PRINT.info("Opened: %s", DEPLOYMENT + "_CommandsArgs.csv")
            #
