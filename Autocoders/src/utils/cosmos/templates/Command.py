...
__CHEETAH_genTime__ = 1529345487.938647
__CHEETAH_genTimestamp__ = 'Mon Jun 18 11:11:27 2018'
__CHEETAH_src__ = 'Command.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Jun 18 09:10:28 2018'
...
<%=render "_''')
        ...
        write(u'''} %>
''')
        for name, desc, types, neg_offset, bit_offset, bits, type, min_val, max_val, default in VFFSL(SL,"cmd_items",True): # generated from line 14, col 5
            if VFFSL(SL,"neg_offset",True): # generated from line 15, col 5
                write(u'''    PARAMETER ''')
