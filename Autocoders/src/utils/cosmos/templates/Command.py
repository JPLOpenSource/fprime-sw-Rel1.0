...
__CHEETAH_genTime__ = 1528930974.524768
__CHEETAH_genTimestamp__ = 'Wed Jun 13 16:02:54 2018'
__CHEETAH_src__ = 'Command.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Jun 13 15:59:21 2018'
...
<%=render "_''')
        ...
        write(u'''} %>
''')
        for name, desc, types, neg_offset, bit_offset, bits, type, min_val, max_val, default in VFFSL(SL,"cmd_args",True): # generated from line 14, col 5
