...
__CHEETAH_genTime__ = 1528414421.975893
__CHEETAH_genTimestamp__ = 'Thu Jun  7 16:33:41 2018'
__CHEETAH_src__ = '../src/utils/cosmos/templates/Channel.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Jun  7 16:33:40 2018'
...
TELEMETRY ''')
        ...
        write(u'''"
<%= render "_${target_lower}_tlm_chn_hdr.txt", locals: {id: ${id}} %>
    APPEND_ITEM VALUE ${value_bits} ${value_type} "Value"''')
