// ======================================================================
// \title  ZmqPub/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for ZmqPub component test harness base class
//
// \copyright
...
#ifndef ZmqPub_TESTER_BASE_HPP
#define ZmqPub_TESTER_BASE_HPP
...
namespace Zmq {
  ...
  //! \class ZmqPubTesterBase
  //! \brief Auto-generated base class for ZmqPub component test harness
  //!
  class ZmqPubTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object ZmqPubTesterBase
      //!
      virtual void init(
    ...
    protected:
      ...
      //! Construct object ZmqPubTesterBase
      //!
      ZmqPubTesterBase(
      ...
      //! Destroy object ZmqPubTesterBase
      //!
      virtual ~ZmqPubTesterBase(void);
    ...
    protected:
      ...
      //! Handle event ZP_ServerConnectionOpened
      //!
      virtual void logIn_ACTIVITY_HI_ZP_ServerConnectionOpened(
          void
      );

      //! Size of history for event ZP_ServerConnectionOpened
      //!
      U32 eventsSize_ZP_ServerConnectionOpened;
    ...
    protected:
      ...
      //! Handle channel ZP_BytesSent
      //!
      virtual void tlmInput_ZP_BytesSent(
          const Fw::Time& timeTag, /*!< The time*/
          const U32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel ZP_BytesSent
      //!
      typedef struct {
        Fw::Time timeTag;
        U32 arg;
      } TlmEntry_ZP_BytesSent;

      //! The history of ZP_BytesSent values
      //!
      History<TlmEntry_ZP_BytesSent> 
        *tlmHistory_ZP_BytesSent;
